...
SECRET_KEY = '#)_lwz0^82u)f!88_01(pc@x&x^o79-f^gaxo(--q8is0#%*uk'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'capstone.context_processors.all_sensors',
                'capstone.context_processors.all_alarms',
                'capstone.context_processors.refresh_time',
            ],
        },
    },
]
